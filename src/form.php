...
<body>
    ...
    <textarea rows="2" cols="100" readonly disabled>curl -d secret=MySecretString -d dataset-a=1.0 -d dataset-b=10.5 <?= getUrl() ?></textarea><br />
    <br />
    <form method="POST" action="/">
        ...
        <input type="text" id="name1" name="name1" value="<?= isset($_GET['name1']) ? htmlspecialchars($_GET['name1']) : ''; ?>" pattern="[a-z0-9\-]{1,15}" placeholder="name"> =
        <input type="number" id="value1" name="value1" step="any" pattern="[0-9.]{1,10}" placeholder="value"><br />

        <label>Dataset 2:</label>
        <input type="text" id="name2" name="name2" value="<?= isset($_GET['name2']) ? htmlspecialchars($_GET['name2']) : ''; ?>" pattern="[a-z0-9\-]{1,15}" placeholder="name"> =
        <input type="number" id="value2" name="value2" step="any" pattern="[0-9.]{1,10}" placeholder="value"><br />

        <label>Dataset 3:</label>
        <input type="text" id="name3" name="name3" value="<?= isset($_GET['name3']) ? htmlspecialchars($_GET['name3']) : ''; ?>" pattern="[a-z0-9\-]{1,15}" placeholder="name"> =
        <input type="number" id="value3" name="value3" step="any" pattern="[0-9.]{1,10}" placeholder="value"><br />

        <label>Dataset 4:</label>
        <input type="text" id="name4" name="name4" value="<?= isset($_GET['name4']) ? htmlspecialchars($_GET['name4']) : ''; ?>" pattern="[a-z0-9\-]{1,15}" placeholder="name"> =
        <input type="number" id="value4" name="value4" step="any" pattern="[0-9.]{1,10}" placeholder="value"><br />

        <label>Dataset 5:</label>
        <input type="text" id="name5" name="name5" value="<?= isset($_GET['name5']) ? htmlspecialchars($_GET['name5']) : ''; ?>" pattern="[a-z0-9\-]{1,15}" placeholder="name"> =
